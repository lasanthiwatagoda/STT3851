...
```{r, echo = FALSE}
Leader <- data.frame(SMSPE = c(BeatThis, SurrattElizabeth, WrayJenna, GoardMatt, TettertonKinsey, PartridgeTim, RecareyVeronica, LambdinEmily, LopezMonica,JordanKlein))
```
