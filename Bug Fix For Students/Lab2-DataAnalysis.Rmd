...
To display the saved file as shown in Figure [1.1](./JPG/YourFileName.jpeg), use the `include_graphics()` function from `knitr`.

```{r, fig.cap = "Using knitr::include_graphics()", echo=FALSE}
include_graphics("./JPG/YourFileName.jpeg")
```
...
## Additional Graphical and Numerial Summaries
