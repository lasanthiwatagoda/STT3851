---
title: "STT 3851 Syllabus - Spring 2026"
author: ''
date: ""
output:
  html_document:
...
**Class meeting:** TR 02:00pm - 03:15pm, WA209B

**Office:** WA340 or Virtual zoom 

**Online Office Hours:**  Tuesday 10:00 - 11:30 AM. [`Click here to go to office hours`](https://appstate.zoom.us/j/92697128817?pwd=SW9LSnNwU3BzODk2MU1aM2cyb0EvQT09) 

**In-person Office Hours:**  Tuesday/ Thursday 03:15 - 04:00 PM in WA340
...
* 30% of the course grade will come from quizzes and homework (8).
...
* 05% of the course grade will come from participation (attendance, participation in discussion in-class).
...
*Tests:* Two tests will be given. The date of each test can be found on the pacing guide.
...
You must have an active internet connection and be registered in the course to access the server. To access the server, point any web browser to <https://mathr.appstate.edu/>.  You will need to acknowledge the connection is unsecure and possibly add a security exception to your web browser. Use your Appstate Username and Password to access the server.  
...
#[Home Page](https://lasanthiwatagoda.github.io/STT3851/) - [Assignments](https://lasanthiwatagoda.github.io/STT3851/Assignments/AssignmentsSTT3851Spring2025.html) 