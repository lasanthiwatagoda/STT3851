...
observations to train, or teach, our method how to estimate $f$.
  * Let $X_{ij}$ represent the value of the ___ predictor, or input, for observation __, where
$i = 1, 2,...,n$ and $j = 1, 2,...,p$.
  * Let __ represent the response variable for the $i^{th}$__ observation.
